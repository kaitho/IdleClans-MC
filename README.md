...
- Browse items grouped by crafting category.
- See all supported crafting categories with recipe counts.
...
- Each recipe has a `category`, `output`, and `ingredients`.
- Add or edit recipe entries there to match the latest Idle Clans data.

Current crafting categories in the UI:
- Smithing
- Woodworking
- Fletching
- Leatherworking
